...
class AdminUsersResource(Resource):
    ...
    def post(self):
        ...
        logging.info(f"in AdminUsersResource:action = {action}, password = {password}")
        ...
        if action == USER_ACTION_REGISTER:
            ...
            logging.info(f"in AdminUsersResource:action = {action}, password = {password}, username = {username} ")
